...
const wordList = [
    ...
    {
        word: "initialization",
        hint: "What is the 'int i=0' called in: for (int i=0; i<10; i++)"
    },
    
    {
        word: "condition",
        hint: "What is the 'i<10' called in: for (int i=0; i<10; i++)"
    },
    
    {
        word: "iteration",
        hint: "What is the 'i++' called in: for (int i=0; i<10; i++)"
    },
    
    {
        word: "break",
        hint: "Keyword used to exit a loop before it naturally completes."
    },
];
